  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.bottom}>
        <button type="button" className={styles.btnKakao} onClick={handleKakao} aria-label="카카오로 로그인">
          <img src={kakaoIcon} alt="" className={styles.icon} aria-hidden />
          카카오톡으로 로그인
        </button>

        <button type="button" className={styles.btnNaver} onClick={handleNaver} aria-label="네이버로 로그인">
          <img src={naverIcon} alt="" className={styles.icon} aria-hidden />
          네이버로 로그인
        </button>

        <button type="button" className={styles.btnGoogle} onClick={handleGoogle} aria-label="Google로 로그인">
